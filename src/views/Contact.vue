          ...
          <div class="bg-white/80 backdrop-blur-md p-8 rounded-[2.5rem] shadow-sm border border-[#8B3A3A]/10">
            ...
            <div class="space-y-8">
              ...
              <div class="flex items-start space-x-5 group">
                ...
                <div class="pt-1">
                  <h4 class="text-sm font-bold text-stone-900 uppercase tracking-widest mb-1">WhatsApp</h4>
                  <a href="https://wa.me/62881037320409" target="_blank" class="text-stone-500 hover:text-[#8B3A3A] transition-colors leading-relaxed text-base font-medium">+62 881-0373-20409</a>
                </div>
              </div>
            </div>
          </div>
