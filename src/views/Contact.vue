              ...
              <div class="flex items-start space-x-5 group">
                <div class="pt-1 w-full">
                  ...
                  <div class="flex space-x-4">
                    ...
                    <!-- Instagram logo -->
                    <a href="https://www.instagram.com/kokorokarae/" target="_blank" class="w-12 h-12 bg-rose-50 hover:bg-rose-100 rounded-xl flex items-center justify-center transition-colors text-[#8B3A3A]" title="Instagram">
                    ...
                    <!-- WhatsApp logo -->
                    <a href="https://wa.me/62881037320409" target="_blank" class="w-12 h-12 bg-rose-50 hover:bg-rose-100 rounded-xl flex items-center justify-center transition-colors text-[#8B3A3A]" title="WhatsApp">
